...
import { run as runMockJob } from "./executors/mockExecutor.js";
import { run as runHttpJob } from "./executors/httpExecutor.js";
...
class WorkerAgent {
  constructor(systemInfo) {
    ...
    this.executor = config.executorMode === "http" ? { run: runHttpJob } : { run: runMockJob };
    this.status = "idle";
